...
//获取点赞数据
$limit = (($page - 1)*10).',10';
$sql = "select id,userid,zanid as wid,intime from qm_zan where (zanid in (select id from qm_wenzhang where userid = $userid) and type = 1) 
    order by intime desc limit $limit";
