...
$sql = "select id from qm_tehui where name like '%".$condition."%' order by intime desc limit 4";
...
$count = dbCount("qm_tehui", $con, "name like '%".$condition."%'");
...
if($count > 0){
    ...
    foreach($tz_list as &$tz_item){
        ...
        //点赞数
        $tz_item['zan'] = dbCount("qm_zan", $con, "type = 1 and zanid = ".$tz_item['id']);
