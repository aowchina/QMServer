...
CREATE TABLE `qm_pj` (
  ...
  `orderid` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='åŒ»é™¢è¯„ä»·è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qm_point_record` (
  ...
  `userid` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=537 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='积分记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qm_relation_wt` (
  ...
  `intime` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=582 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='ÎÄÕÂÓë±êÇ©¹ØÏµ±í';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qm_sc` (
  ...
  `intime` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='ç”¨æˆ·æ”¶è—è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `qm_session` VALUES ('4447923245cf41e647383045a9d1e711',1,0,'1472552472','__default|a:8:{s:15:\"session.counter\";i:16;s:19:\"session.timer.start\";i:1472550479;s:18:\"session.timer.last\";i:1472552444;s:17:\"session.timer.now\";i:1472552472;s:22:\"session.client.browser\";s:121:\"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Safari/537.36\";s:8:\"registry\";O:9:\"JRegistry\":1:{s:7:\"\0*\0data\";O:8:\"stdClass\":5:{s:11:\"application\";O:8:\"stdClass\":1:{s:4:\"lang\";s:0:\"\";}s:9:\"com_tehui\";O:8:\"stdClass\":3:{s:6:\"tehuis\";O:8:\"stdClass\":1:{s:8:\"ordercol\";N;}s:4:\"edit\";O:8:\"stdClass\":1:{s:5:\"tehui\";O:8:\"stdClass\":2:{s:2:\"id\";a:1:{i:0;i:165;}s:4:\"data\";N;}}s:5:\"types\";O:8:\"stdClass\":1:{s:8:\"ordercol\";N;}}s:12:\"com_wenzhang\";O:8:\"stdClass\":1:{s:9:\"wenzhangs\";O:8:\"stdClass\":1:{s:8:\"ordercol\";N;}}s:9:\"com_cuser\";O:8:\"stdClass\":1:{s:6:\"cusers\";O:8:\"stdClass\":1:{s:8:\"ordercol\";N;}}s:7:\"com_act\";O:8:\"stdClass\":1:{s:4:\"acts\";O:8:\"stdClass\":1:{s:8:\"ordercol\";N;}}}}s:4:\"user\";O:5:\"JUser\":25:{s:9:\"\0*\0isRoot\";b:1;s:2:\"id\";s:3:\"973\";s:4:\"name\";s:10:\"Super User\";s:8:\"username\";s:5:\"admin\";s:5:\"email\";s:16:\"183107471@qq.com\";s:8:\"password\";s:34:\"$P$DSK2isjYoEz/KIxlVSSThfBp2fk28/0\";s:14:\"password_clear\";s:0:\"\";s:8:\"usertype\";s:10:\"deprecated\";s:5:\"block\";s:1:\"0\";s:9:\"sendEmail\";s:1:\"1\";s:12:\"registerDate\";s:19:\"2015-08-24 00:42:34\";s:13:\"lastvisitDate\";s:19:\"2016-08-30 09:47:58\";s:10:\"activation\";s:1:\"0\";s:6:\"params\";s:92:\"{\"admin_style\":\"\",\"admin_language\":\"\",\"language\":\"\",\"editor\":\"\",\"helpsite\":\"\",\"timezone\":\"\"}\";s:6:\"groups\";a:1:{i:8;s:1:\"8\";}s:5:\"guest\";i:0;s:13:\"lastResetTime\";s:19:\"0000-00-00 00:00:00\";s:10:\"resetCount\";s:1:\"0\";s:10:\"\0*\0_params\";O:9:\"JRegistry\":1:{s:7:\"\0*\0data\";O:8:\"stdClass\":6:{s:11:\"admin_style\";s:0:\"\";s:14:\"admin_language\";s:0:\"\";s:8:\"language\";s:0:\"\";s:6:\"editor\";s:0:\"\";s:8:\"helpsite\";s:0:\"\";s:8:\"timezone\";s:0:\"\";}}s:14:\"\0*\0_authGroups\";a:2:{i:0;i:1;i:1;i:8;}s:14:\"\0*\0_authLevels\";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:\"\0*\0_authActions\";N;s:12:\"\0*\0_errorMsg\";N;s:10:\"\0*\0_errors\";a:0:{}s:3:\"aid\";i:0;}s:13:\"session.token\";s:32:\"f708358072458c7b7da86e3eb8cc78ef\";}',973,'admin','');
...
CREATE TABLE `qm_users_common` (
  ...
  `intime` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=267 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Appç”¨æˆ·è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qm_users_dsf` (
  ...
  `intime` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=235 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='第三方openid与用户userid关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qm_users_login` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=483 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Appç”¨æˆ·ç™»å½•è®°å½•è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qm_wenzhang` (
  ...
  `parentid` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1029 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Ìû×Ó/ÈÕ¼Ç±í';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qm_wenzhang_pl` (
  ...
  `intime` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=438 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='ÆÀÂÛ¼ÇÂ¼±í';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qm_zan` (
  ...
  `intime` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=688 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='ç‚¹èµžè®°å½•è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-08-30 18:29:05
