...
// 获取文章收藏信息
$sql = "select id from qm_wenzhang where ctime = $ctime";
$wz_id = dbLoad(dbQuery($sql, $con), true);
$wz_id = $wz_id['id'];
$count = dbCount("qm_sc", $con, "userid = $userid and scid = $wz_id");
