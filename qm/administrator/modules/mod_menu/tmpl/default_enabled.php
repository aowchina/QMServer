...
for($i = 0; $i < count($components); $i++){
	if(!($components[$i]->id == 22 || $components[$i]->id == 18 || $components[$i]->id == 13 || $components[$i]->id == 2 || $components[$i]->id == 21 || 
		$components[$i]->id == 10 || $components[$i]->id == 17 || $components[$i]->id == 7 || $components[$i]->id == 16)){

		$new_components[] = $components[$i];
	}
}
